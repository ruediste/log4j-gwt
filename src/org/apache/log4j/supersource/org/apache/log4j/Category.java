...
public class Category implements AppenderAttachable {
    ...
    */
    ...
    protected void forcedLog(String fqcn, Priority level, Object message, Throwable t) {
        ...
        String ndc = NDC.toLogString();
        String mdc = MDC.toLogString();
        if ((ndc.length() > 2) || (mdc.length() > 2)) {
            msg.append("\t");
            msg.append(ndc);
            msg.append("\t");
            msg.append(mdc);
        }
        julLogger.log(level.getJulLevel(), msg.toString(), t);
    }
    ...
    */
    ...
    public boolean isDebugEnabled() {
        return julLogger.isLoggable(Level.DEBUG.getJulLevel());
    }
    ...
    */
    public boolean isEnabledFor(Priority level) {
        return julLogger.isLoggable(level.getJulLevel());
    }
    ...
    */
    public boolean isInfoEnabled() {
        return julLogger.isLoggable(Level.INFO.getJulLevel());
    }
    ...
    */
    ...
    synchronized public void removeAllAppenders() {
        // appenders are not supported in GWT port
    }
    ...
    */
    ...
    /**
       ...
       @since 0.8.4
     */
    public void setResourceBundle(Object bundle) {
        // GWT REMOVED
    }
